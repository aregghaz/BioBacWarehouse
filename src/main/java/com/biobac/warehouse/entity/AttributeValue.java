...
@Table(name = "attribute_value",
        uniqueConstraints = {
                ...
                @UniqueConstraint(columnNames = {"definition_id", "product_group_id"}),
                @UniqueConstraint(columnNames = {"definition_id", "ingredient_id"}),
                @UniqueConstraint(columnNames = {"definition_id", "ingredient_group_id"}),
                @UniqueConstraint(columnNames = {"definition_id", "warehouse_id"}),
                @UniqueConstraint(columnNames = {"definition_id", "warehouse_group_id"})
        })
