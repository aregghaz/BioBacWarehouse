...
public class WarehouseGroupSpecification {
    public static Specification<WarehouseGroup> buildSpecification(Map<String, FilterCriteria> filters) {
    ...
    public static Specification<WarehouseGroup> belongsToGroups(List<Long> groupIds) {
        return (root, query, cb) -> {
